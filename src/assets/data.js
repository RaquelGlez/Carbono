...
import twitter_icon from "./svg/twitter_icon.svg";

const imageTextCard = "Región donde se ubica, Estado.";
const titleCard = "Nombre del proyecto escrito en dos líneas, lo que sea.";
const textCard =
